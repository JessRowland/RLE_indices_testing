...
class Display:
	...
	title('Benthic cover (%)',fontsize=12)
	for r in range(reefmap.srrange):
	    plt, = plot(range(1,params.years+1),output.outavsSR['C'][r],
		 color=colors[r])
            line.append(plt)
	xlim(1,params.years)
	xticklabels = getp(gca(),'xticklabels')
	...
	line = []
	for r in range(reefmap.srrange):
	    plt, = plot(range(1,params.years+1),output.outavsSR['T'][r],
		 color=colors[r])
	    line.append(plt)
	xlim(1,params.years)
	xticklabels = getp(gca(),'xticklabels')
	...
	line = []
	for r in range(reefmap.srrange):
	    plt, = plot(range(1,params.years+1),output.outavsSR['M'][r],
		 color=colors[r])
	    line.append(plt)
	xlim(1,params.years)
	xticklabels = getp(gca(),'xticklabels')
	...
	line = []
	for r in range(reefmap.srrange):
	    plt, = plot(range(1,params.years+1),output.outavsSR['E'][r],
		 color=colors[r])
	    line.append(plt)
	xlabel('year')
	xlim(1,params.years)
	...
	title('Consumer biomass (kg/km$^2$ x 10$^3$)',fontsize=12)
	for r in range(reefmap.srrange):
	    plt, = plot(range(1,params.years+1),output.outavsSR['H'][r],
		 color=colors[r])
	    line.append(plt)
	xlim(1,params.years)
	xticklabels = getp(gca(),'xticklabels')
	...
	line = []
	for r in range(reefmap.srrange):
	    plt, = plot(range(1,params.years+1),output.outavsSR['Ps'][r],
		 color=colors[r])
	    line.append(plt)
	xlim(1,params.years)
    	xticklabels = getp(gca(),'xticklabels')
	...
	line = []
	for r in range(reefmap.srrange):
	    plt, = plot(range(1,params.years+1),output.outavsSR['Pl'][r],
		 color=colors[r])
	    line.append(plt)
	xlim(1,params.years)
    	xticklabels = getp(gca(),'xticklabels')
