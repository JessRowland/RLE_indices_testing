# conda install matplotlib # in terminal
# pip install netCDF4 # in terminal
# import netCFD4
...
Simulate()                     # Model execution: to switch off preceed with '#'
Outputs(inputpath,outputpath)  # Output/visualization processing: to switch off
                               # preceed with '#'
